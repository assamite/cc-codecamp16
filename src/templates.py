...
//Possible differentiation of positive and negative settings in order to have character reactions and thoughts that make sense in terms of them. 
'''
GPR = {'he', 'she'}
...
CHARACTER_DESCRIPTIONS = [
    ...
    "Even #NAME’s closest acquantances steered clear of #GPR because they knew what a #NEG #GNN #GPR was.",
